...
public protocol FixedLengthString: RawRepresentable, MapleStoryCodable where RawValue == String {
...
extension FixedLengthString where Self: MapleStoryDecodable {
...
extension FixedLengthString where Self: MapleStoryEncodable {
