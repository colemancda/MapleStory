...
internal extension BBSOperationRequest {
    ...
    var mode: Mode {
        ...
        case .listReply: return .listReply
        case .reply: return .reply
        case .deleteReply: return .deleteReply
        }
    }
}
...
extension BBSOperationRequest: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case mode, isEdit, id, title, body, icon, notice, reply
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        case .delete:
            self = .delete(id: try container.decode(UInt32.self, forKey: .id))
        case .list:
            self = .list(id: try container.decode(UInt32.self, forKey: .id))
        case .listReply:
            self = .listReply(id: try container.decode(UInt32.self, forKey: .id))
        case .reply:
            let id = try container.decode(UInt32.self, forKey: .id)
            let body = try container.decode(String.self, forKey: .body)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .new(let notice, let title, let body, let icon):
            try container.encode(false, forKey: .isEdit)
            try container.encode(notice, forKey: .notice)
            try container.encode(title, forKey: .title)
            try container.encode(body, forKey: .body)
            try container.encode(icon, forKey: .icon)
        case .edit(let id, let notice, let title, let body, let icon):
            try container.encode(true, forKey: .isEdit)
            try container.encode(id, forKey: .id)
            try container.encode(notice, forKey: .notice)
            try container.encode(title, forKey: .title)
            try container.encode(body, forKey: .body)
            try container.encode(icon, forKey: .icon)
        case .delete(let id), .list(let id), .listReply(let id):
            try container.encode(id, forKey: .id)
