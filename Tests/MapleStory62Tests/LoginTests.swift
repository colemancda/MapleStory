...
final class LoginTests: XCTestCase {
    ...
    func testClientError() {
        ...
        let packet: Packet<ClientOpcode> = [0x1A, 0x00, 0x01, 0x23, 0x30, 0xE9, 0x3A, 0x00, 0x00, 0x00, 0x00]
        let value = ClientErrorRequest(error: true, value0: 0x3AE93023, value1: 0)
        XCTAssertEncode(value, packet)
        XCTAssertDecode(value, packet)
    }
    
    func testClientError2() throws {
        
        let encryptedData = Data([0x11, 0xC2, 0x86, 0xFB, 0x91, 0xE1, 0x39, 0xD9, 0x05, 0x01, 0xA3])
        let packet: Packet<ClientOpcode> = [0x1A, 0x00, 0x01, 0x7D, 0x5B, 0xD5, 0xEE, 0x00, 0x00, 0x00, 0x00]
        ...
        let value = ClientErrorRequest(error: true, value0: 4006959997, value1: 0)
    ...
    func testClientErrorStart() throws {
        ...
        let value = try decoder.decode(ClientStartError.self, from: packet)
        NSLog(value.error)
    }
